...
public class CsvToBean<T> {
	...
	protected Object convertValue(final String value, final PropertyDescriptor prop)
	 ...
	 */
	protected PropertyEditor getPropertyEditor(final PropertyDescriptor desc)
			throws InstantiationException, IllegalAccessException {
