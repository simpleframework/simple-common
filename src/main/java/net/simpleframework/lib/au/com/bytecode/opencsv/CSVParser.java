...
public class CSVParser {
	 ...
	 * ignored. I.E. if the quote character is set to null then there is no quote
	 * character.
	 */
	...
	private boolean anyCharactersAreTheSame(final char separator, final char quotechar,
			final char escape) {
