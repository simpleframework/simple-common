 ...
 * ASM MethodVistor object. It is to be assumed by the implementor that the JIT
 * has already produced
 * the necessary bytecode up until this point. The implementor most only
 * implement the necessary bytecode
 * instructions to retrieve the property, leaving the resultant value on the
 * stack. <b>DO NOT</b> implement
 * bytecode that calls a return instruction such as ARETURN. This will be done
 * automatically by the JIT.<br/>
 * <br/>
 ...
 * stack, and simply performs the necessary
 * CHECKCAST, and call to the needed method in the accessor to translate the
 * property call. <br/>
 * <br/>
