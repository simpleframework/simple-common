...
public class DeclareNode extends Node {
	...
	public DeclareNode(final int begin, final String name, final char[] template, final int start,
			final int end) {
		this.begin = begin;
		this.name = name;
	...
	public Object eval(final TemplateRuntime runtime, final TemplateOutputStream appender,
		...
		runtime.getNamedTemplateRegistry().addNamedTemplate(
				MVEL.eval(contents, cStart, cEnd - cStart, ctx, factory, String.class),
