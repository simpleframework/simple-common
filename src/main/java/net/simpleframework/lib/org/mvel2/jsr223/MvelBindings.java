...
public class MvelBindings implements Bindings {
	 ...
	 *         if m is null
	 */
	public MvelBindings(final Map<String, Object> m) {
		if (m == null) {
	...
	public void putAll(final Map<? extends String, ? extends Object> toMerge) {
		...
		for (final Map.Entry<? extends String, ? extends Object> entry : toMerge.entrySet()) {
	 ...
	 * <tt>k</tt> such
	 * that <tt>(key==null ? k==null : key.equals(k))</tt>. (There can be at most
	 * one such mapping.)
	 *
	 * @param key
	 ...
	 * <tt>null</tt> if the map
	 * contained no mapping for this key. (A <tt>null</tt> return can also
	 * indicate that the map
	 * previously associated <tt>null</tt> with the specified key if the
	 * implementation supports
	 * <tt>null</tt> values.) The map will not contain a mapping for the
	 * specified key once the call
	 * returns.
	 *
	 * @param key
