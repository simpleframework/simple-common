...
public class TemplateSyntaxError extends RuntimeException {
	...
	public TemplateSyntaxError(final String s) {
		super(s); // To change body of overridden methods use File | Settings |
						// File Templates.
	}

	public TemplateSyntaxError(final String s, final Throwable throwable) {
		super(s, throwable); // To change body of overridden methods use File |
									// Settings | File Templates.
	}

	public TemplateSyntaxError(final Throwable throwable) {
