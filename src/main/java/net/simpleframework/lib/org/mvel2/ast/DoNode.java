...
public class DoNode extends BlockNode {
	...
	public DoNode(final char[] expr, final int start, final int offset, final int blockStart,
	...
	public Object getReducedValueAccelerated(final Object ctx, final Object thisValue,
		...
		final VariableResolverFactory ctxFactory = new MapVariableResolverFactory(
				new HashMap<String, Object>(0), factory);
