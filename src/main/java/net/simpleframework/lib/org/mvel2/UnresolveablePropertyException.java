...
public class UnresolveablePropertyException extends RuntimeException {
	...
	public UnresolveablePropertyException(final ASTNode astNode, final Throwable throwable) {
		super("unable to resolve token: " + astNode.getName(), throwable);
		this.name = astNode.getName();
	}

	public UnresolveablePropertyException(final ASTNode astNode) {
		super("unable to resolve token: " + astNode.getName());
		this.name = astNode.getName();
	}

	public UnresolveablePropertyException(final String name) {
