...
import net.simpleframework.lib.org.mvel2.conversion.ArrayHandler;
import net.simpleframework.lib.org.mvel2.conversion.BigDecimalCH;
import net.simpleframework.lib.org.mvel2.conversion.BigIntegerCH;
import net.simpleframework.lib.org.mvel2.conversion.BooleanCH;
import net.simpleframework.lib.org.mvel2.conversion.ByteCH;
import net.simpleframework.lib.org.mvel2.conversion.CharArrayCH;
import net.simpleframework.lib.org.mvel2.conversion.CharCH;
import net.simpleframework.lib.org.mvel2.conversion.CompositeCH;
import net.simpleframework.lib.org.mvel2.conversion.DoubleCH;
import net.simpleframework.lib.org.mvel2.conversion.FloatCH;
import net.simpleframework.lib.org.mvel2.conversion.IntArrayCH;
import net.simpleframework.lib.org.mvel2.conversion.IntegerCH;
import net.simpleframework.lib.org.mvel2.conversion.ListCH;
import net.simpleframework.lib.org.mvel2.conversion.LongCH;
import net.simpleframework.lib.org.mvel2.conversion.ObjectCH;
import net.simpleframework.lib.org.mvel2.conversion.SetCH;
import net.simpleframework.lib.org.mvel2.conversion.ShortCH;
import net.simpleframework.lib.org.mvel2.conversion.StringArrayCH;
import net.simpleframework.lib.org.mvel2.conversion.StringCH;
import net.simpleframework.lib.org.mvel2.util.FastList;
...
public class DataConversion {
	...
	public static boolean canConvert(final Class toType, final Class convertFrom) {
		if (isAssignableFrom(toType, convertFrom)) {
			return true;
		}
	...
	public static <T> T convert(final Object in, final Class<T> toType) {
		if (in == null) {
			return null;
		}
		...
		final ConversionHandler h = CONVERTERS.get(toType);
	 ...
	 */
	public static void addConversionHandler(final Class type, final ConversionHandler handler) {
