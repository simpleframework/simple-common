...
public class OptimizerFactory {
	...
	public static void setDefaultOptimizer(final String name) {
		try {
			...
			ao.init();
			// clear optimizer so next call to getThreadAccessorOptimizer uses the
			// default again, don't set thread optimizer
			// or else static initializers setting the default will unintentionally
			// set up ThreadLocals
