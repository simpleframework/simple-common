...
public class OperatorNode extends ASTNode {
	...
	public OperatorNode(final Integer operator, final char[] expr, final int start,
	...
	public Object getReducedValueAccelerated(final Object ctx, final Object thisValue,
		...
		throw new CompileException("illegal use of operator: " + getOperatorSymbol(operator), expr,
				start);
	}
