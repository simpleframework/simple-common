...
public class IndexedPreFixIncNode extends ASTNode {
	...
	public IndexedPreFixIncNode(final int register, final ParserContext pCtx) {
		super(pCtx);
	...
	public Object getReducedValueAccelerated(Object ctx, final Object thisValue,
		...
		vResolver.setValue(ctx = MathProcessor.doOperations(vResolver.getValue(), Operator.ADD,
				DataTypes.INTEGER, 1));
		return ctx;
	}
