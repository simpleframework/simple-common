...
public class ResolverTools {
	 ...
	 */
	public static <T extends VariableResolverFactory> T appendFactory(
			final VariableResolverFactory root, final T newFactory) {
	 ...
	 * @return An instance of the new factory.
	 */
	public static <T extends VariableResolverFactory> T insertFactory(
			final VariableResolverFactory root, final T newFactory) {
		if (root.getNextFactory() == null) {
			root.setNextFactory(newFactory);
		} else {
