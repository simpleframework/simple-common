...
public interface VariableResolver extends Serializable {
	 ...
	 * completely necessary, and is particularily
	 * only of benefit to systems that require use of MVEL's strict typing
	 * facilities. In most cases, this implementation
	 ...
	 * should just return 0 in custom
	 * implentations.
	 *
