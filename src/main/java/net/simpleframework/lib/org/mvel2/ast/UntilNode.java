...
public class UntilNode extends BlockNode {
	...
	public UntilNode(final char[] expr, final int start, final int offset, final int blockStart,
	...
	public Object getReducedValueAccelerated(final Object ctx, final Object thisValue,
		...
		final VariableResolverFactory ctxFactory = new MapVariableResolverFactory(new HashMap(0),
				factory);
