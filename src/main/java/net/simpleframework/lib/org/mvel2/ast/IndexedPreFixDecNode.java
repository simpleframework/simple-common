...
public class IndexedPreFixDecNode extends ASTNode {
	...
	public IndexedPreFixDecNode(final int register, final ParserContext pCtx) {
		super(pCtx);
	...
	public Object getReducedValueAccelerated(Object ctx, final Object thisValue,
		...
		vResolver.setValue(ctx = MathProcessor.doOperations(vResolver.getValue(), Operator.SUB,
				DataTypes.INTEGER, 1));
		return ctx;
	}
