...
abstract public class MethodDelegate {
	...
	public static MethodDelegate createStatic(final Class targetClass, final String methodName,
			final Class iface) {
	...
	public static MethodDelegate create(final Object target, final String methodName,
			final Class iface) {
		final Generator gen = new Generator();
	...
	public static class Generator extends AbstractClassGenerator {
		...
		private static final Type METHOD_DELEGATE = TypeUtils
				.parseType("net.simpleframework.lib.net.sf.cglib.reflect.MethodDelegate");
		...
		public void generateClass(final ClassVisitor v) throws NoSuchMethodException {
			...
			CodeEmitter e;
			ce.begin_class(Opcodes.V1_2, Opcodes.ACC_PUBLIC, getClassName(), METHOD_DELEGATE,
			...
			// newInstance
			e = ce.begin_method(Opcodes.ACC_PUBLIC, NEW_INSTANCE, null);
			e.new_instance_this();
			e.dup();
			e.dup2();
