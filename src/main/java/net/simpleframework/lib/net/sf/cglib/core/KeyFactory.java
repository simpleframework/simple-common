...
abstract public class KeyFactory {
	...
	private final static int PRIMES[] = { 11, 73, 179, 331, 521, 787, 1213, 1823, 2609, 3691, 5189,
			7247, 10037, 13931, 19289, 26627, 36683, 50441, 69403, 95401, 131129, 180179, 247501,
			340057, 467063, 641371, 880603, 1209107, 1660097, 2279161, 3129011, 4295723, 5897291,
			8095873, 11114263, 15257791, 20946017, 28754629, 39474179, 54189869, 74391461, 102123817,
			140194277, 192456917, 264202273, 362693231, 497900099, 683510293, 938313161, 1288102441,
			1768288259 };
	...
	public static class Generator extends AbstractClassGenerator {
		...
		public void generateClass(final ClassVisitor v) {
			...
			int seed = 0;
			CodeEmitter e = ce.begin_method(Opcodes.ACC_PUBLIC,
			...
			// equals
			e = ce.begin_method(Opcodes.ACC_PUBLIC, EQUALS, null);
			...
			// toString
			e = ce.begin_method(Opcodes.ACC_PUBLIC, TO_STRING, null);
