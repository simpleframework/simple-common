...
public class InterceptFieldTransformer extends ClassEmitterTransformer {
    ...
    private static final Type CALLBACK =
      TypeUtils.parseType("net.simpleframework.lib.net.sf.cglib.transform.impl.InterceptFieldCallback");
    private static final Type ENABLED =
      TypeUtils.parseType("net.simpleframework.lib.net.sf.cglib.transform.impl.InterceptFieldEnabled");
