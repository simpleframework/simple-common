...
public interface NamingPolicy {
	 ...
	 *        "net.simpleframework.lib.net.sf.cglib.Enhancer")
	 * @param key
	 *        A key object representing the state of the parameters; for caching
	 *        to work properly, equal keys should result
	 *        in the same generated class name. The default policy incorporates
	 ...
	 * in the future, affect the caching of classes generated by
