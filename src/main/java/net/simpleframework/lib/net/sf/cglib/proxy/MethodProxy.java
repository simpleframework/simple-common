...
import net.simpleframework.lib.net.sf.cglib.core.NamingPolicy;
import net.simpleframework.lib.net.sf.cglib.core.Signature;
import net.simpleframework.lib.net.sf.cglib.reflect.FastClass;

/**
 * Classes generated by {@link Enhancer} pass this object to the
 * registered {@link MethodInterceptor} objects when an intercepted method is
 * invoked. It can
 * be used to either invoke the original method, or call the same method on a
 * different
...
public class MethodProxy {
	 ...
	 * {@link net.simpleframework.lib.net.sf.cglib.reflect.FastMethod} class
	 * for similar functionality.
	 */
	public static MethodProxy create(final Class c1, final Class c2, final String desc,
	...
	/**
	 * Return the {@link net.simpleframework.lib.net.sf.cglib.reflect.FastClass}
	 * method index
	 ...
	 * @return the MethodProxy instance, or null if no applicable matching method
	 *         is found
	...
	public static MethodProxy find(final Class type, final Signature sig) {
		try {
			final Method m = type.getDeclaredMethod(MethodInterceptorGenerator.FIND_PROXY_NAME,
	...
	public Object invoke(final Object obj, final Object[] args) throws Throwable {
		try {
			init();
			final FastClassInfo fci = fastClassInfo;
